...
다시말해 `i + nums[i]` 이하의 범위들은 다 점프로 올 수 있는 곳들이라는 뜻이다.
...
![무지성_dp_결과](https://github.com/user-attachments/assets/9b729d74-ba36-4ad4-b110-5651dfcaf8b5)
...
![최적화_dp_결과](https://github.com/user-attachments/assets/3d785c73-584f-4715-9d86-a86e83269efd)
